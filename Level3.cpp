...
int Level3() {
  ...
  ofstream read;
  read.open("Level_3_Results.txt");
  read << "Level 3 Results:" << endl;
  read << "Your Percentage Correct for level 3 is " << finalper << "%" << endl;
  read << "Your Total Number of Questions Answered for Level 3 are " << howmany << endl;
